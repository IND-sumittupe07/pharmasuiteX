  ...
  try {
    const result = await query(
      `SELECT c.id, c.full_name, c.mobile, c.age, c.gender, c.city, c.medical_condition, c.notes, c.customer_code,
              c.total_spend, c.last_visit, c.created_at,
              MIN(cm.refill_date) as earliest_refill
       FROM customers c
       LEFT JOIN customer_medicines cm ON c.id = cm.customer_id
...
// PUT: Update customer (NEW ENDPOINT FOR EDIT)
