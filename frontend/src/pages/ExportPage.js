...
export default function ExportPage() {
  ...
  const exports = [
    { key:"customers", icon:"👥", title:"Customer Database", desc:"All customer profiles, contacts, conditions, doctors and spend history", color:"#2563eb", bg:"#eff6ff", endpoint:"customers", file:`PharmaSuiteX_Customers_${today}.csv` },
    { key:"medicines", icon:"💊", title:"Medicine Stats", desc:"Prescription counts and dispensing data per medicine", color:"#8b5cf6", bg:"#f5f3ff", endpoint:"medicines", file:`PharmaSuiteX_Medicines_${today}.csv` },
    { key:"refills",   icon:"🔔", title:"Refill Queue", desc:"All upcoming refills within 30 days with urgency levels", color:"#ef4444", bg:"#fef2f2", endpoint:"refills",   file:`PharmaSuiteX_Refills_${today}.csv` },
    { key:"campaigns", icon:"📣", title:"Campaign Report", desc:"All campaigns with targets, channels and delivery counts", color:"#f59e0b", bg:"#fffbeb", endpoint:"campaigns", file:`PharmaSuiteX_Campaigns_${today}.csv` },
    { key:"purchases", icon:"🧾", title:"Purchase History", desc:"All customer purchase records with invoice details and amounts", color:"#10b981", bg:"#f0fdf4", endpoint:"purchases", file:`PharmaSuiteX_Purchases_${today}.csv` },
  ];
