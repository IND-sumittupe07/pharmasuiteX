  ...
  if (view === "detail" && selectedCustomer) {
    return (
      <div className="fade-in" style={{ maxWidth: 1400, margin: "0 auto" }}>
        <button onClick={() => { setView("list"); setSelectedCustomer(null); fetchCustomers(); }}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 24 }}>
          ...
          <div className="card" style={{ padding: 24 }}>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <div style={{ fontSize: 18, fontWeight: 700, color: "var(--txt1)", marginTop: 16 }}>{selectedCustomer.full_name}</div>
            ...
            <button onClick={() => { /* could open edit form here */ }}
              style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {/* ✅ Active Medicines with Refill Tracking */}
            <div className="card" style={{ padding: 24 }}>
