      ...
      <div style={{ maxWidth: 800, margin: "0 auto", background: "white", borderRadius: 20, padding: "40px 48px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 32 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 13, color: "#94a3b8" }}>PharmaSuiteX - Pharmacy Suite · Last updated: March 2026</div>
          </div>
        </div>

        {[
          { title: "1. Acceptance of Terms", content: "By registering and using PharmaSuiteX, you agree to these Terms and Conditions. If you do not agree, please do not use our service. These terms apply to all users including pharmacy owners and staff members." },
          { title: "2. Description of Service", content: "PharmaSuiteX is a pharmacy management software that helps medical store owners manage customer records, medicine inventory, refill reminders, and marketing campaigns. We provide this service on a subscription basis." },
          ...
          { title: "5. Data Ownership", content: "You retain full ownership of all customer and business data you enter into PharmaSuiteX. We do not sell, share, or use your data for any purpose other than providing the service. You can export or delete your data at any time." },
          { title: "6. Customer Data & Privacy", content: "You are responsible for obtaining consent from your customers before storing their personal health information in PharmaSuiteX. You must comply with all applicable Indian laws regarding patient data privacy. Do not store sensitive financial or Aadhaar information in the system." },
          { title: "7. Prohibited Uses", content: "You may not use PharmaSuiteX for illegal purposes, to send spam or unsolicited messages, to store or distribute harmful content, to attempt to hack or compromise the system, or to resell the service without written permission." },
          ...
          { title: "9. Limitation of Liability", content: "PharmaSuiteX is a management tool and does not provide medical advice. We are not responsible for any medical decisions made based on data in the system. Our liability is limited to the amount paid for the service in the last month." },
          ...
          { title: "12. Contact", content: "For questions about these terms, contact us at legal@pharmasuitex.in or call +91 98765 43210 (Mon–Sat, 9AM–6PM IST)." },
        ].map((section, i) => (
        ...
        <div style={{ marginTop: 32, padding: 20, background: "#f0fdf4", borderRadius: 12, fontSize: 13, color: "#166534" }}>
          ✅ By using PharmaSuiteX, you confirm that you have read, understood, and agree to these Terms & Conditions.
        </div>
      </div>
    </div>
  );
