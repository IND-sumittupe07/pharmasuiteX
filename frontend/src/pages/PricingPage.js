...
export default function PricingPage() {
  ...
  const handleUpgrade = async (plan) => {
    if (plan.id === "enterprise") { window.open("mailto:support@pharmasuitex.in?subject=Enterprise Plan", "_blank"); return; }
    ...
    try {
      ...
      const rzp = new window.Razorpay({
        ...
        name: "PharmaSuiteX - Pharmacy Suite",
      ...
      <div className="card" style={{
        ...
        <div>
          ...
          <div style={{fontSize:13,color:"#64748b"}}>
            {isExpired
              ? "Renew now to continue using PharmaSuiteX"
              : expiresAt
