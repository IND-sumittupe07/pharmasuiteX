    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc", padding: "40px 20px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", background: "white", borderRadius: 20, padding: "40px 48px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)" }}>
        ...
        <div style={{ padding: "14px 18px", background: "#eff6ff", borderRadius: 12, marginBottom: 28, fontSize: 13, color: "#1e40af", fontWeight: 500 }}>
          🔒 PharmaSuiteX is committed to protecting your privacy and the privacy of your customers. This policy explains what data we collect, how we use it, and your rights.
        </div>
        ...
        {[
          ...
          { title: "7. Your Rights", content: "You have the right to: access all data we hold about you, correct inaccurate data, export your data in CSV format, delete your account and all associated data, opt out of non-essential communications. Contact us at privacy@pharmasuitex.in to exercise these rights." },
          { title: "8. Cookies", content: "PharmaSuiteX uses only essential cookies for authentication (keeping you logged in). We do not use advertising or tracking cookies. You can clear cookies in your browser settings, but this will log you out." },
          { title: "9. Children's Privacy", content: "PharmaSuiteX is designed for business use by adults. We do not knowingly collect personal information from children under 18. If you believe a minor has provided information, contact us immediately." },
          { title: "10. Changes to This Policy", content: "We will notify you of significant changes to this policy via email or in-app notification at least 7 days before they take effect. Continued use of PharmaSuiteX after changes indicates acceptance." },
          { title: "11. Contact & Grievances", content: "For privacy concerns or to exercise your rights, contact our Data Protection Officer: Email: privacy@pharmasuitex.in | Phone: +91 98765 43210 | Address: PharmaSuiteX, [Your City], India. We will respond within 7 business days." },
        ].map((section, i) => (
